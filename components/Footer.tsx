        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <p className="mt-4 text-sm text-white max-w-sm">
              Transforming affordable housing management with intelligent automation and compliance tools.
            </p>
          </div>
          ...
          <div className="sm:col-span-1">
            ...
            <ul role="list" className="mt-6 space-y-4">
              <li className="flex items-center space-x-3">
                ...
                <span className="text-sm text-white">info@regtime.com</span>
              </li>
              <li className="flex items-center space-x-3">
                <Phone className="h-5 w-5 text-white" />
                <span className="text-sm text-white">646-386-0654</span>
              </li>
              <li className="flex items-center space-x-3">
